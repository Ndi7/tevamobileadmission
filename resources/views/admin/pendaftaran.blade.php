...
@php
$wajib = is_array($p->mapel_wajib)
    ? $p->mapel_wajib
    : json_decode($p->mapel_wajib ?? '[]');

$reguler = is_array($p->mapel_reguler)
    ? $p->mapel_reguler
    : json_decode($p->mapel_reguler ?? '[]');

$ekskul = is_array($p->mapel_ekskul)
    ? $p->mapel_ekskul
    : json_decode($p->mapel_ekskul ?? '[]');
@endphp
